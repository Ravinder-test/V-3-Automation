...
public class ProjectDetailPage {
 ...
 // NEW LOCATORS for Breadcrumb and Project Search Page verification
    ...
    public void openProjectDetailPage() {
        System.out.println("Attempting to open Project Detail Page...");
        ...
        System.out.println("Entered 'Habtoor Grand Residences' into search.");
        
        // 2. Click on the suggestion
        wait.until(ExpectedConditions.elementToBeClickable(projectLocationSuggestion)).click();
        System.out.println("Clicked on location suggestion.");
        ...
        System.out.println("Spinner disappeared after location suggestion click.");
        ...
        System.out.println("Clicked project title link. Waiting for new tab...");
        ...
        for (String handle : allWindows) {
            if (!handle.equals(originalWindow)) {
                ...
                System.out.println("Switched to new tab: " + newTabHandle);
                break;
            }
        }
        ...
        waitForSpinnerToDisappear(); 
        System.out.println("Spinner disappeared after switching to new tab.");
        ...
        System.out.println("Project Detail Title visible: " + driver.findElement(projectDetailTitle).getText());


        // 6. Close the original window and switch back to the new tab
        // This part of the logic remains as per your original design.
        // If you intend to keep both tabs open, remove this section.
        driver.switchTo().window(originalWindow);
        driver.close();
        System.out.println("Closed original window.");
        driver.switchTo().window(newTabHandle); // Switch back to the newly opened tab
        System.out.println("Switched back to Project Detail tab for further interactions.");
    }
    ...
    public boolean isUnitListTableVisible() {
        By locator = By.xpath("//div[@class='chakra-table__container css-zipzvv'][.//th[.//p[text()='Project Name']]]");
